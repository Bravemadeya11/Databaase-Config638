...
INSERT INTO Item (ItemID, ItemDescription, Cost) VALUES
...
SELECT 
    CONCAT(P.FirstName, ' ', P.LastName) AS PatientFullName,
    T.TreatmentName,
    I.ItemDescription AS ItemDescriptionSum,
    I.Cost AS ItemCost
FROM 
    PatientTreatment PT
    JOIN Patient PA ON PT.PatientID = PA.PatientID
    JOIN Person P ON PA.PatientID = P.PersonID
    JOIN Treatment T ON PT.TreatmentID = T.TreatmentID
    JOIN TreatmentItem TI ON T.TreatmentID = TI.TreatmentID
